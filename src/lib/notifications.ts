...
// Frases para PREMIUM: puro engajamento, sem venda.
...
// Frases para NÃO PREMIUM: engajamento + convite ao teste grátis / assinatura.
const FRASES_GRATIS = [
  'Suas tiragens GRÁTIS do oráculo esperam por você ✨ Abra e pergunte.',
  'O oráculo tem um recado pra você hoje 🔮 Faça sua leitura grátis.',
  'Amor, trabalho ou saúde? Pergunte ao oráculo agora — de graça ✨',
  'Comece o dia com uma tiragem grátis e sua mensagem de luz 🌙',
